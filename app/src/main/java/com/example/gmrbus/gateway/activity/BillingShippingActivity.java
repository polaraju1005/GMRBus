...
import com.example.gmrbus.gateway.adapters.CardAdapter;
import com.example.gmrbus.gateway.adapters.CardNameAdapter;
import com.example.gmrbus.gateway.adapters.EMIAdapter;
import com.example.gmrbus.gateway.adapters.EMIPlansDTO;
import com.example.gmrbus.gateway.adapters.PayOptAdapter;
import com.example.gmrbus.gateway.dto.CardTypeDTO;
import com.example.gmrbus.gateway.dto.EMIOptionDTO;
    ...
    public void fetch_payment_details() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constants.JSON_URL,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put(AvenuesParams.ACCESS_CODE, initialScreen.getStringExtra(AvenuesParams.ACCESS_CODE).toString().trim());
                params.put(AvenuesParams.CURRENCY,initialScreen.getStringExtra(AvenuesParams.CURRENCY).toString().trim());
                params.put(AvenuesParams.AMOUNT,initialScreen.getStringExtra(AvenuesParams.AMOUNT).toString().trim());
                params.put(AvenuesParams.CUSTOMER_IDENTIFIER, initialScreen.getStringExtra(AvenuesParams.CUSTOMER_IDENTIFIER).toString().trim());
                return params;
            }
